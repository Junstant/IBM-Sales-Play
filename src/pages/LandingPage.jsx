  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <AnimatePresence>
        {showPrivacyBanner && (
          <motion.div 
            className="bg-gray-50 border-b border-gray-200 text-sm py-3 px-4 flex justify-between items-center"
            ...
            {isMenuOpen && (
              ...
              >
                <nav className="flex flex-col space-y-4">
                  ...
                  <motion.div 
                    className="px-4 pt-4 border-t border-gray-200 space-y-2"
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                  ...
                  >
                    <motion.button 
                      onClick={onLoginClick} 
                      className="w-full text-left px-4 py-2 text-black hover:bg-gray-50 hover:text-red-600 transition-colors"
                      whileHover={{ x: 10 }}
                    >
                      Office Banking
                    </motion.button>
