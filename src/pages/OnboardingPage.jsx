  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-red-100 flex flex-col items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      >
          ...
          <div className="relative z-40">
            ...
            <div className="text-center mb-12">
              <motion.div 
                ...
                animate={progress === 100 ? "active" : "idle"}
              >
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Nuestro asistente de IA te guiará paso a paso para completar tu registro 
                de manera rápida, segura y personalizada. ¡Es como tener un experto financiero 
                ...
                return (
                  ...
                  >
                    <div className={`p-4 rounded-full mb-4 ${
                      ...
                      feature.color === 'yellow' ? 'bg-yellow-100' : 'bg-blue-100'
                    }`}>
            ...
            {/* AI Preview */}
            <motion.div 
              className="w-full p-8 bg-gradient-to-r from-red-50 to-red-100 rounded-2xl border-2 border-red-200 mb-8"
              variants={itemVariants}
              ...
              <div className="flex items-center justify-center space-x-4">
                ...
                <div className="text-center">
                  <p className="text-red-800 font-semibold text-lg">
                    🤖 "¡Hola! Soy tu asistente personal de Banco Marfil"
                  </p>
                  <p className="text-red-600 text-sm mt-1">
                    Te ayudaré a abrir tu cuenta en menos de 5 minutos
                  </p>
                </div>
              </div>
            </motion.div>
        ...
        {/* Footer Info */}
        <motion.footer 
          className="text-center text-gray-600 relative z-30"
          variants={itemVariants}
        >
          <motion.div 
            className="bg-white/60 backdrop-blur-sm rounded-xl p-6 border border-white/50 mb-4"
            whileHover={{ scale: 1.02 }}
          >
